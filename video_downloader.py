...
class Scrapper:
    ...
    def get_all_links(self):
        ...
        videos_link = content.find_all('a', attrs={'href': re.compile('.mp4')})
        links = [link['href'] for link in videos_link]
        links.reverse()
        return links
...
class Main:
    def __init__(self, url, quality):
        self.url = url
        self.quality = quality
        self.scraper = Scrapper(self.url, self.quality)
...
a = Main(url='https://www.namasha.com/v/Ozrw1mCa', quality='480')
a.download()
